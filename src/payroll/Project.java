...
public class Project extends JFrame implements ActionListener{
     ...
     Project() {
      ...
      JMenu edit =new JMenu("Update");
        ...
        s1.setFont(new Font("monospaced",Font.PLAIN,15));
        s1.setMnemonic('U');
        ...
        s2.setFont(new Font("monospaced",Font.PLAIN,15));
        s2.setMnemonic('p');
        ...
        s3.setFont(new Font("monospaced",Font.PLAIN,15));
        s3.setMnemonic('T');
        ...
        m8i1.setFont(new Font("monospaced", Font.PLAIN, 15));
        m8i1.setMnemonic('X');
